...
-- Listage des données de la table northwind.customers : 93 rows
...
-- Listage des données de la table northwind.orders : 830 rows
...
-- Listage des données de la table northwind.order_details : 2 155 rows
...
-- Listage des données de la table northwind.products : 77 rows
...
-- Listage des données de la table northwind.suppliers : 29 rows
